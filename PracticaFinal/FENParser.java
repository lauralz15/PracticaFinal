...
public class FENParser {
    ...
    public FENParser() {
        // Si -Dfen.ascii está definido, usar ese valor
        if (System.getProperty("fen.ascii") != null) {
            useAscii = Boolean.getBoolean("fen.ascii");
            return;
        }

        // Intentar detectar si podemos usar Unicode
        useAscii = true; // por defecto ASCII a menos que confirmemos soporte Unicode
